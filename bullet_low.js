...
const VERSION = "1.0.0";
localStorage.setItem("lombre_bullet_low_version", VERSION)
...
const GITHUB_VERSION_URL = "https://raw.githubusercontent.com/LombreBlanche34/krunker_bullet_low/refs/heads/main/version"
const GITHUB_REPO_URL = "https://github.com/LombreBlanche34/krunker_bullet_low"
...
async function checkForUpdate() {
    ...
    if (latestVersion !== VERSION) {
        ...
        alert(`New version for bullet_low.js\nActual: ${VERSION} New: ${latestVersion}\n${change}`)
    }
}
...
Promise.all([
    ...
    function updateAmmoColor() {
        ...
        // Extraire la valeur max (enlever le "| " au début)
        ...
        if (!isNaN(currentValue) && !isNaN(maxValue)) {
            ...
            if (percentage < config.PERCENTAGE) {
                ...
                ammoElement.style.color = ""; // couleur par défaut
            }
        }
    }

    // Observer les changements sur ammoVal
    ...
    // Observer les changements sur ammoMax (au cas où il change aussi)
    ...
    updateAmmoColor(); // vérifie une première fois dès que dispo
});
